...
pub struct ComponentDefinitionLifecycleActionsRoleProbeHttp {
    ...
    /// HTTP permits the use of repeated headers.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "httpHeaders")]
    pub http_headers: Option<Vec<ComponentDefinitionLifecycleActionsRoleProbeHttpHttpHeaders>>,
    /// Represents the type of HTTP request to be made, such as "GET," "POST," "PUT," etc.
    /// If not specified, "GET" is the default method.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
...
/// HTTPHeader describes a custom header to be used in HTTP probes
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentDefinitionLifecycleActionsRoleProbeHttpHttpHeaders {
    /// The header field name.
    /// This will be canonicalized upon output, so case-variant names will be understood as the same header.
    pub name: String,
    /// The header field value
